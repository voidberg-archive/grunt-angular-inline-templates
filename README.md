...
## The "angular_inline_template" task

### Overview
In your project's Gruntfile, add a section named `angular_inline_template` to the data object passed into `grunt.initConfig()`.
